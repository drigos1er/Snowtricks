...
Encore
    ...
    .addEntry('css/font-awesome.min', './assets/css/font-awesome.min.css')
    ...
    .addEntry('js/jquery.scrollTo', './assets/js/jquery.scrollTo.js')
    .addEntry('js/wow.min', './assets/js/wow.min.js')
